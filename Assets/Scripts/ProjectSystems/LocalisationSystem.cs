...
namespace Studio.ProjectSystems
{
    ...
    {
        private string _pathToLocalisation = "Localisation/";
        ...
        public void Construct(DataSystem dataSystem)
        {
            ...
            EventBus.OnCacheLoadedEvent += OnCacheLoadedEventHandler;
        }
        ...
        private void LoadLanguage()
        {
            ...
            EventBus.OnLanguageWasChangedEvent?.Invoke((Languages)CurrentLanguage);
        }
